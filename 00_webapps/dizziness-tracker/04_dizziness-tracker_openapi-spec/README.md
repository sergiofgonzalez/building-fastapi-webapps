...
Note that the OpenAPI spec [`oas.yaml`](./oas.yaml) has been manually written and has not been wired into the application, so it might contain typos and errors in the syntax.
