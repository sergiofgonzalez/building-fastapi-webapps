...
| NOTE: |
| :---- |
| This version was discarded because the data layer models didn't performed as I wanted (the relationships between the tables were weird). |
...
Next:
+ work on populating the symptoms
...
```bash
uv init 08_dizziness-tracker_entries-hexagonal-arch
```
